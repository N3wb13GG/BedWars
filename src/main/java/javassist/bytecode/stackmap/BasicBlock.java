...
/**
 * A basic blocks is a sequence of bytecode that does not contain jump/branch
...
public class BasicBlock
{
    ...
    protected BasicBlock[] exit;   // null if the blocks is a leaf.
    protected boolean stop;        // true if the blocks ends with an unconditional jump.
    ...
    throws BadBytecode
    {
        ...
        throw new BadBytecode("no basic blocks at " + pos);
    }
    ...
    public static class Maker
    {
        ...
        protected void makeJsr(HashMap marks, int pos, int target, int size) throws BadBytecode
        {
            ...
            BasicBlock[] jumps = makeArray(to.blocks, next.blocks);
