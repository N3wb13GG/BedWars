...
public class ControlFlow
{
     ...
     * array is equivalent to <code>node.blocks().index()</code>.
     *
    ...
    public static class Block extends BasicBlock
    {
        ...
        /**
         * Returns the position of this blocks in the array of
        ...
        /**
         * Returns the length of this blocks.
         */
        public int length()
        {
            return length;
        ...
        /**
         * Returns the number of the control paths entering this blocks.
         */
        ...
        /**
         * Returns the blocks that the control may jump into this blocks from.
         */
        ...
        /**
         * Returns the n-th blocks that may be executed after this
         * blocks.
         *
    ...
    public static class Node
    {
        ...
        /**
         * Returns the basic blocks indicated by this node.
         */
        public Block block()
        {
            return block;
    ...
    public static class Catcher
    {
        ...
        /**
         * Returns the first blocks of the catch clause.
         */
        public Block block()
        {
            return node;
